...
export default function event() {
  ...
  const newProjectFormModal = document.querySelector(
  ...
  function sidebarEventHandler(event) {
    ...
    if (target.classList.contains('delete-project')) {
      if (
        confirm('This will delete Project and all Todo list. Delete project?')
      ) {
        currentProjectIndex = target.parentNode.dataset.projectIndex;
  ...
  screen.initialize(projectsList, mainContent, project.getProjectList(), []);
}
